            ...
            <div className="eventPreview__content panel--bg mh-full grid">
                <div className="eventPreview__about text-white ff-serif centeredContainer side-padding flow">
                    ...
                    <p className="eventPreview__description">
                        ...
                        minima reiciendis vel quo dolore dolor in laboriosam et,
                        repellendus exercitationem quos quis fugit. Sunt error delectus
                        odit libero perferendis tenetur! Unde ratione, possimus nobis
                        maiores quia error illum sint sunt adipisci quos autem, nisi iste
                        quibusdam, in provident. Voluptates voluptatem, quaerat temporibus
                        nobis inventore labore earum incidunt fugiat sit aspernatur?
                    </p>
                    <div className="flow">
