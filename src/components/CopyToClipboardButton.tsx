import { m, useMotionValue, useTransform, Variants } from 'framer-motion'
import { useState } from 'react'

import useCopyToClipboard from '../hooks/useCopyToClipboard'
import Button from './Button'

const clipboardIconVariants: Variants = {
    clicked: { opacity: 0 },
    unclicked: { opacity: 1 },
}
...
export default function CopyToClipboardButton({ textToCopy }: Props) {
    ...
    const opacity = useTransform(pathLength, [0.05, 0.1], [0, 1])
